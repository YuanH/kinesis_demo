...
def processRecords(records):
    ...
    for r in records:
        ...
        return_event['time']=json.loads(data['event'])['event_timestamp']
        # below chunk breaks the firehose since "reingest" and "frombucket" is not accepted
        # by splunk HEC
        """
...
def lambda_handler(event, context):
    ...
    # print("list(processRecords(event['records']))") #[debug]
    # print(records) #[debug]
    projectedSize = 0
    ...
    if len(putRecordBatches) > 0:
        ...
        for recordBatch in putRecordBatches:
            if isSas:
                ...
                print("calling putRecordsToFirehoseStream")
